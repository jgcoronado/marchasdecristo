 ...
 *  @var array $rg @var string $slug @var string $q @var string $csrf */
...
<form action="/dashboard/acompanamientos/<?= V::e($slug) ?>/anios-rango<?= V::e($q ?? '') ?>" method="POST" class="inline-form" data-anios-form
