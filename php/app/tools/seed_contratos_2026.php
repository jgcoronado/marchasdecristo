 ...
 *
 * UBICACION: php/app/tools/seed_contratos_2026.php (junto a migrate_ingest.php
 * y sql/, mismo sitio que las demas herramientas de mantenimiento del repo).
 * USO (desde la RAIZ del proyecto, justo encima de php/):
 *   php php/app/tools/seed_contratos_2026.php contratos_ss_sevilla_2026.csv            # DRY-RUN
 *   php php/app/tools/seed_contratos_2026.php contratos_ss_sevilla_2026.csv --commit   # inserta
 *
 ...
 * localidad (cae en "Sin localidad" en /temporada/{anio}).
...
// Este fichero vive en php/app/tools/, asi que APP_DIR es un nivel por encima.
