 ...
 * 2026-09-25; se queda el #58):
 *   #322 "AM Virgen de la Cabeza de Exfiliana" (Valle del Zalabí) -> #58 "AM Virgen de la Cabeza" (Exfiliana)
 * La duplicada la creó la carga de acompañamientos y solo tienen contratos
 ...
 *
 * Uso:
 *   php php/app/tools/fusionar_bandas_322_58.php --dry-run
 *   php php/app/tools/fusionar_bandas_322_58.php
 */
...
try {
    ...
    $pdo->exec("UPDATE log_actor SET ACTOR = 'cli:fusionar_bandas_322_58' WHERE ID = 1");
    ...
    $dest = $backupDir . '/mdc-' . date('Ymd-His') . '-pre-fusionar-bandas-322-58.db';
