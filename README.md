...
│   └── quality.sh       # auditoría de calidad y duplicidad (ver docs/code-quality.md)
├── .github/workflows/  # CI (lint + smoke tests), Quality (PHPStan + duplicidad) y deploy automático por FTP (rama `pre` → PRE, `main` → PRO)
├── tools/
